...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 9, 0)) || defined(AIC_RHEL9_BACKPORT)
...
#endif
{
    ...
    #elif defined(AIC_RHEL9_BACKPORT)
 ...
 */
#if LINUX_VERSION_CODE > KERNEL_VERSION(6, 7, 0) || defined(AIC_RHEL9_BACKPORT)
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 13, 0)) || defined(AIC_RHEL9_BACKPORT)
 ...
 */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 17, 0) || defined(AIC_RHEL9_BACKPORT)
...
int radio_idx,
#endif
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 14, 0) || defined(AIC_RHEL9_BACKPORT)
...
int rwnx_cfg80211_start_radar_detection(struct wiphy *wiphy,
                                        ...
                                        , u32 cac_time_ms
                                    #endif
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 12, 0)) || defined(AIC_RHEL9_BACKPORT)
                                        , int link_id
#endif
                                        )
{
